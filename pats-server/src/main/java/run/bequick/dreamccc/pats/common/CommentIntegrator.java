...
public class CommentIntegrator implements Integrator {
    ...
    private void processComment(Metadata metadata) {
        for (PersistentClass persistentClass : metadata.getEntityBindings()) {
            ...
            if (clz.isAnnotationPresent(ColumnComment.class)) {
                ColumnComment comment = clz.getAnnotation(ColumnComment.class);
    ...
    private void fieldComment(PersistentClass persistentClass, String columnName) {
        try {
            ...
            if (field.isAnnotationPresent(ColumnComment.class)) {
                String comment = field.getAnnotation(ColumnComment.class).value();
